export class routes {
  ...
  public static get core1(): string {
    return '/dashboard';
  }
  ...
  public static get productList(): string {
    return '/deshboard/inventory/product/product-list';
  }
  public static get addProduct(): string {
    return '/deshboard/inventory/product/add-product';
  }
