...
export class DataService {
  ...
  postCategory(categories:string){
    const categoryData = { name: categories };
   return this.http.post('http://208.64.33.118:4152/api/Category',categoryData)
  }
  ...
  getCategoryList1(
    ...
    return this.http.get('http://208.64.33.118:4152/api/Category', { params });
  }
